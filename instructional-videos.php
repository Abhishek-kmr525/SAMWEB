...
<title>Instructional Videos | Sam&reg;&#65039; Sustained Acoustic Medicine</title>
...
<style>
  *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .science-card h3 { font-size: 18px; line-height: 1.2; margin-bottom: 10px; }
...
<style>
  ...
  .video-card:hover {
    ...
    box-shadow: 0 24px 80px rgba(194, 213, 0, 0.08);
  }
  ...
  /* Form Section (similar to contact-us.php) */
...
<main>
  <section class="video-hub">
    <div class="hub-header reveal">
      <h1>sam&reg; Training <span style="color: var(--green);">Hub</span></h1>
      <p>Master the application and maintenance of your sam&reg; device with our comprehensive video library. Designed for athletes, patients, and medical professionals.</p>
    </div>

    <div class="video-grid">
      
      <!-- Featured Video -->
      <div class="video-card featured-card reveal" style="transition-delay: 0.1s;">
        <div class="video-info">
          <div class="video-tag">Essential</div>
          <h3>sam&reg; Quick Start Video</h3>
          <p>Everything you need to know to get started with your new sam&reg; device. This comprehensive guide covers unboxing, basic setup, and your very first treatment session.</p>
        </div>
        <div class="video-frame">
          <iframe src="https://www.youtube.com/embed/dSDngzVJNyw?autoplay=1&loop=1&playlist=dSDngzVJNyw&mute=1&controls=0&cc_load_policy=0&iv_load_policy=3" title="sam&reg; Quick Start Video" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
      </div>

      <!-- Standard Videos -->
      <div class="video-card standard-card reveal" style="transition-delay: 0.2s;">
        <div class="video-info">
          <div class="video-tag">Care</div>
          <h3>sam&reg; Maintenance Guide</h3>
          <p>Learn how to properly clean, charge, and store your device to ensure optimal performance and longevity.</p>
        </div>
        <div class="video-frame">
          <iframe src="https://www.youtube.com/embed/0Kzq7sqB5jc?autoplay=1&loop=1&playlist=0Kzq7sqB5jc&mute=1&controls=0&cc_load_policy=0&iv_load_policy=3" title="sam&reg; Maintenance Guide" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
      </div>

      <div class="video-card standard-card reveal" style="transition-delay: 0.3s;">
        <div class="video-info">
          <div class="video-tag">Application</div>
          <h3>Upper Body Placement</h3>
          <p>Detailed instructions for applying sam&reg; applicators to shoulders, elbows, and other upper body injuries.</p>
        </div>
        <div class="video-frame">
          <iframe src="https://www.youtube.com/embed/c_TCGpAgx4s?autoplay=1&loop=1&playlist=c_TCGpAgx4s&mute=1&controls=0&cc_load_policy=0&iv_load_policy=3" title="sam&reg; Upper Body Placement" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
      </div>

      <div class="video-card standard-card reveal" style="transition-delay: 0.4s;">
        <div class="video-info">
          <div class="video-tag">Application</div>
          <h3>Lower Body Placement</h3>
          <p>Step-by-step guidance for treating knees, hamstrings, calves, and Achilles tendons for maximum recovery.</p>
        </div>
        <div class="video-frame">
          <iframe src="https://www.youtube.com/embed/SPGSYOzE8Gc?autoplay=1&loop=1&playlist=SPGSYOzE8Gc&mute=1&controls=0&cc_load_policy=0&iv_load_policy=3" title="sam&reg; Lower Body Placement" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
      </div>

      <div class="video-card standard-card reveal" style="transition-delay: 0.5s;">
        <div class="video-info">
          <div class="video-tag">Tips</div>
          <h3>sam&reg; for Sensitive Skin</h3>
          <p>Best practices and specialized application techniques for patients with skin sensitivities or allergies.</p>
        </div>
        <div class="video-frame">
          <iframe src="https://www.youtube.com/embed/aK6W4ZhlKFM?autoplay=1&loop=1&playlist=aK6W4ZhlKFM&mute=1&controls=0&cc_load_policy=0&iv_load_policy=3" title="sam&reg; for Sensitive Skin" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
      </div>

      <div class="video-card standard-card reveal" style="transition-delay: 0.6s;">
        <div class="video-info">
          <div class="video-tag">Education</div>
          <h3>Patient Expectations</h3>
          <p>Understand the healing timeline, what you will feel during treatment, and how to track your recovery progress.</p>
        </div>
        <div class="video-frame">
          <iframe src="https://www.youtube.com/embed/ERp9dkLFOeA?autoplay=1&loop=1&playlist=ERp9dkLFOeA&mute=1&controls=0&cc_load_policy=0&iv_load_policy=3" title="sam&reg;: Patient Expectation" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
      </div>
  ...
  <section class="contact-section reveal" style="background: var(--gray-50); color: var(--black); padding: 120px 24px; border-top: 1px solid var(--gray-200);">
    <div style="max-width: 700px; margin: 0 auto;">
      <div class="contact-form-container" id="contact-form">
        <h2>Contact Us Today!</h2>
        <p>Call us at <strong>(888) 202-9831</strong> or fill out the contact form below and someone from our team will connect with you.</p>

        <form action="submit-enquiry.php" method="POST" data-enquiry-form="true" id="contact-form">
          <input type="hidden" name="redirect_to" value="instructional-videos.php">
          <input type="hidden" name="form_source" value="instructional-videos.php">
