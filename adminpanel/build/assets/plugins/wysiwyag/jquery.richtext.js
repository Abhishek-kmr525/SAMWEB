(function($) {
    ...
    $.fn.richText = function(options) {
        ...
        if (settings.imageHTML &&
            ...
            // custom image form
            $imageForm.php(settings.imageHTML);
        } else {
            // default image form
            $imageForm.append(
                $formItem.clone()
        ...
        if (settings.fileHTML &&
            ...
            // custom file form
            $fileForm.php(settings.fileHTML);
        } else {
            // default file form
            $fileForm.append(
                $formItem.clone()
        ...
        function init() {
            ...
            } else if ($inputElement.php()) {
                value = $inputElement.php();
                attributes = $inputElement.prop("attributes");
                // loop through <select> attributes and apply them on <div>
                $.each(attributes, function() {
                    if (this.name) {
            ...
            $editorView.php($inputElement.val());
        ...
        $(document).on('contextmenu', '.richText-editor', function(e) {
            ...
            if ($target.prop("tagName") === "A") {
                ...
                $list.append($li.clone().php('<span class="fa fa-link"></span>'));
                ...
                $list.append($li.clone().php('<span class="fa fa-image"></span>'));
                $target.parents('.richText').append($list);
        ...
        */
        ...
        function undo() {
            ...
            $editor.find('.richText-editor').php(value);
            setHistoryButtons();
        }
