		...
		1: function(t, e, n) {
			...
			var s = function() {
				...
				return e = t, (n = [{
					...
					value: function(t) {
						var e = i()(this.markup);
						if (this.options && this.options.contents && e.php(this.options.contents), this.options && this.options.className && e.addClass(this.options.className), this.options && this.options.data && i.a.each(this.options.data, (function(t, n) {
								e.attr("data-bs-" + t, n)
		...
		3: function(t, e, n) {
			...
			var vt = function() {
				...
				return e = t, (n = [{
					...
					value: function(t) {
						...
						if (void 0 === t) return this.invoke("codeview.sync"), e ? this.layoutInfo.codable.val() : this.layoutInfo.editable.php();
						e ? this.invoke("codeview.sync", t) : this.layoutInfo.editable.php(t), this.$note.val(t), this.triggerEvent("change", t, this.layoutInfo.editable)
					}
				}, {
					key: "isDisabled",
					value: function() {
			...
			var Tt = function() {
				...
				return e = t, (n = [{
					...
					key: "applySnapshot",
					value: function(t) {
						null !== t.contents && this.$editable.php(t.contents), null !== t.bookmark && wt.createFromBookmark(this.editable, t.bookmark).select()
					}
				}, {
					key: "rewind",
					value: function() {
						this.$editable.php() !== this.stack[this.stackOffset].contents && this.recordUndo(), this.stackOffset = 0, this.applySnapshot(this.stack[this.stackOffset])
					}
				}, {
					key: "commit",
					value: function() {
					...
					key: "reset",
					value: function() {
						this.stack = [], this.stackOffset = -1, this.$editable.php(""), this.recordUndo()
					}
				}, {
					key: "undo",
					value: function() {
						this.$editable.php() !== this.stack[this.stackOffset].contents && this.recordUndo(), this.stackOffset > 0 && (this.stackOffset--, this.applySnapshot(this.stack[this.stackOffset]))
					}
				}, {
					key: "redo",
					value: function() {
							...
							switch (c.action) {
								...
								case At.resultAction.SumSpanCount:
									if ("top" === e && (c.baseCell.parent ? c.baseCell.closest("tr").rowIndex : 0) <= o[0].rowIndex) {
										var d = i()("<div></div>").append(i()("<td" + u + ">" + pt.blank + "</td>").removeAttr("rowspan")).php();
										a.append(d);
										break
									}
			...
			var Ht = function() {
				...
				return e = t, (n = [{
					...
					value: function() {
						...
						})), this.$editable.attr("spellcheck", this.options.spellCheck), this.$editable.attr("autocorrect", this.options.spellCheck), this.options.disableGrammar && this.$editable.attr("data-bs-gramm", !1), this.$editable.php(pt.php(this.$note) || pt.emptyPara), this.$editable.on(m.inputEventName, g.debounce((function() {
							t.context.triggerEvent("change", t.$editable.php(), t.$editable)
					...
					key: "undo",
					value: function() {
						this.context.triggerEvent("before.command", this.$editable.php()), this.history.undo(), this.context.triggerEvent("change", this.$editable.php(), this.$editable)
					}
				}, {
					key: "commit",
					value: function() {
						this.context.triggerEvent("before.command", this.$editable.php()), this.history.commit(), this.context.triggerEvent("change", this.$editable.php(), this.$editable)
					}
				}, {
					key: "redo",
					value: function() {
						this.context.triggerEvent("before.command", this.$editable.php()), this.history.redo(), this.context.triggerEvent("change", this.$editable.php(), this.$editable)
					}
				}, {
					key: "beforeCommand",
					value: function() {
						this.context.triggerEvent("before.command", this.$editable.php()), document.execCommand("styleWithCSS", !1, this.options.styleWithCSS), this.focus()
					}
				}, {
					key: "afterCommand",
					value: function(t) {
						this.normalizeContent(), this.history.recordUndo(), t || this.context.triggerEvent("change", this.$editable.php(), this.$editable)
					}
				}, {
					key: "tab",
					value: function() {
					...
					value: function(t, e) {
						...
						if ("" !== n) {
							...
							if (this.$editor.find(".note-status-output").php(""), i()(o).css(t, e), n.isCollapsed()) {
								var r = C.head(o);
							...
							var a = i.a.now();
							this.$editor.find(".note-status-output").php('<div id="note-status-output-' + a + '" class="alert alert-info">' + this.lang.output.noSelection + "</div>"), setTimeout((function() {
					...
					key: "isEmpty",
					value: function() {
						return pt.isEmpty(this.$editable[0]) || pt.emptyPara === this.$editable.php()
					}
				}, {
					key: "empty",
					value: function() {
			...
			var Kt = function() {
				...
				return e = t, (n = [{
					...
					value: function() {
						...
						if (this.$codable.val(pt.php(this.$editable, this.options.prettifyHtml)), this.$codable.height(this.$editable.height()), this.context.invoke("toolbar.updateCodeview", !0), this.context.invoke("airPopover.updateCodeview", !0), this.$editor.addClass("codeview"), this.$codable.focus(), e) {
					...
					value: function() {
						...
						this.$editable.php(e), this.$editable.height(this.options.height ? this.$codable.height() : "auto"), this.$editor.removeClass("codeview"), n && this.context.triggerEvent("change", this.$editable.php(), this.$editable), this.$editable.focus(), this.context.invoke("toolbar.updateCodeview", !1), this.context.invoke("airPopover.updateCodeview", !1)
					}
				}, {
					key: "destroy",
					value: function() {
			...
			var re = function() {
				...
				return e = t, (n = [{
					...
					value: function() {
						...
						})).php(this.options.placeholder).prependTo(this.$editingArea), this.update()
					}
				}, {
					key: "destroy",
					value: function() {
					...
					value: function() {
						var t = this.options.dialogsInBody ? this.$body : this.options.container,
							e = ['<div class="form-group note-form-group">', '<label for="note-dialog-link-txt-'.concat(this.options.id, '" class="note-form-label">').concat(this.lang.link.textToDisplay, "</label>"), '<input id="note-dialog-link-txt-'.concat(this.options.id, '" class="note-link-text form-control note-form-control note-input" type="text"/>'), "</div>", '<div class="form-group note-form-group">', '<label for="note-dialog-link-url-'.concat(this.options.id, '" class="note-form-label">').concat(this.lang.link.url, "</label>"), '<input id="note-dialog-link-url-'.concat(this.options.id, '" class="note-link-url form-control note-form-control note-input" type="text" value="http://"/>'), "</div>", this.options.disableLinkTarget ? "" : i()("<div/>").append(this.ui.checkbox({
								...
								checked: !0
							}).render()).php(), i()("<div/>").append(this.ui.checkbox({
				...
				return e = t, (n = [{
					...
					value: function(t) {
						var e, n = t.match(/\/\/(?:(?:www|m)\.)?(?:youtu\.be\/|youtube\.com\/(?:embed\/|v\/|watch\?v=|watch\?.+&v=))([\w|-]{11})(?:(?:[\?&]t=)(\S+))?$/),
							...
							u = t.match(/\/\/v\.qq\.com\/x?\/?(page|cover).*?\/([^\/]+)\.php\??.*/),
							d = t.match(/^.+.(mp4|m4v)$/),
							h = t.match(/^.+.(ogg|ogv)$/),
							f = t.match(/^.+.(webm)$/),
						...
						if (n && 11 === n[1].length) {
							...
							e = i()("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>").attr("frameborder", 0).attr("height", "310").attr("width", "500").attr("src", "https://v.qq.com/txp/iframe/player.php?vid=" + w + "&amp;auto=0")
					...
					value: function() {
						...
						return Object.keys(e).map((function(n) {
							...
							return r.append(i()("<label><kbd>" + n + "</kdb></label>").css({
								width: 180,
								"margin-right": 10
							})).append(i()("<span/>").php(t.context.memo("help." + o) || o)), r.php()
						})).join("")
					}
				}, {
					key: "showHelpDialog",
				...
				return e = t, (n = [{
					...
					value: function(t, e) {
						...
						return this.searchKeyword(t, e, (function(e) {
							(e = e || []).length && (o.php(n.createItemTemplates(t, e)), n.show())
						})), o
					}
				}, {
					key: "handleKeyup",
			...
			var s = r.a.create('<div class="note-editor note-frame panel panel-default"/>'),
				...
				y = r.a.create('<div class="modal note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>', (function(t, e) {
					e.fade && t.addClass("fade"), t.attr({
						"aria-label": e.title
					}), t.php(['<div class="modal-dialog">', '<div class="modal-content">', e.title ? 
				...
				w = r.a.create('<div class="checkbox"></div>', (function(t, e) {
					t.php(["<label" + (e.id ? ' for="note-' + e.id + '"' : "") + ">", '<input type="checkbox"' + (e.id ? ' id="note-' + e.id + '"' : ""), e.checked ? " checked" : "", ' aria-checked="' + (e.checked ? "true" : "false") + '"/>', e.text ? e.text : "", "</label>"].join(""))
				})),
				C = function(t, e) {
					...
					return {
						...
						palette: function(e, n) {
							return r.a.create('<div class="note-color-palette"/>', (function(e, n) {
								...
								e.php(o.join("")), n.tooltip && e.find(".note-color-btn").tooltip({
						...
						removeLayout: function(t, e) {
							t.php(e.editable.php()), e.editor.remove(), t.show()
						}
					}
				};
			n(3), n(4);
