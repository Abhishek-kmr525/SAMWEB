...
(function (global, factory) {
    ...
    ChartInternal.prototype.initWithData = function (data) {
        ...
        $$.selectChart.php("").classed("c3", true);
    ...
    // SVG2 (https://lists.w3.org/Archives/Public/www-svg/2015Jun/0044.php), including the latest spec
    // changes which were implemented in Firefox 43 and Chrome 46.

    (function () {

        if (!("SVGPathSeg" in window)) {
            // Spec: http://www.w3.org/TR/SVG11/single-page.php#paths-InterfaceSVGPathSeg
            ...
            // Spec: http://www.w3.org/TR/SVG11/single-page.php#paths-Interfacewindow.SVGPathElement.
            ...
            if (!("getPathSegAtLength" in window.SVGPathElement.prototype)) {
                ...
                // Spec: https://www.w3.org/TR/SVG11/single-page.php#paths-__svg__SVGPathElement__getPathSegAtLength
        ...
        if (!("SVGPathSegList" in window)) {
            // Spec: http://www.w3.org/TR/SVG11/single-page.php#paths-InterfaceSVGPathSegList
            ...
            // Spec: http://www.w3.org/TR/SVG11/single-page.php#paths-InterfaceSVGAnimatedPathData
            ...
            window.SVGPathSegList.prototype._parsePath = function (string) {
                ...
                // Spec: http://www.w3.org/TR/SVG11/single-page.php#paths-PathDataBNF
    ...
    Chart.prototype.destroy = function () {
        ...
        $$.selectChart.classed('c3', false).php("");
    ...
    ChartInternal.prototype.initTooltip = function () {
        ...
        if (config.tooltip_init_show) {
            ...
            $$.tooltip.php(config.tooltip_contents.call($$, $$.data.targets.map(function (d) {
    ...
    ChartInternal.prototype.showTooltip = function (selectedData, element) {
        ...
        $$.tooltip.php(config.tooltip_contents.call($$, selectedData, $$.axis.getXAxisTickFormat(), $$.getYFormat(forArc), $$.color)).style("display", "block");
