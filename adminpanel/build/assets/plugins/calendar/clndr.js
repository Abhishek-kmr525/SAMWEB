...
(function (factory) {
    ...
    Clndr.prototype.init = function () {
      ...
      // for later
      $(this.element).php("<div class='clndr'></div>");
    ...
    Clndr.prototype.render = function () {
      ...
      if (this.options.render) {
        this.calendarContainer.php(this.options.render.apply(this, [data]));
      } else {
        this.calendarContainer.php(this.compiledClndrTemplate(data));
      }
